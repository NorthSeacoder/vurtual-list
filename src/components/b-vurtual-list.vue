...
export default {
    ...
    computed: {
        ...
        prevCount() {
            return Math.min(this.start, this.renderCount);
        },
        nextCount() {
            return Math.min(this.menuList.length - this.end, this.renderCount);
        },
        visibleData() {
            const vm = this;
            let start = vm.start - vm.prevCount;
            let end = vm.end + vm.nextCount;
    ...
    methods: {
        handleScroll() {
            ...
            const vm = this;
            const {itemHeight, renderCount, padding} = vm;
            ...
            const {offset,start,end}=vm;
            console.log('handleScroll',{scrollTop,offset,start,end})
        ...
        initHighlight(valueList) {
            ...
            console.log({highlightIndex,reservedCount,initScrollTop,maxScrollTop})
